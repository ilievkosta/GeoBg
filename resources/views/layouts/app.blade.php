...
<body>
    <div id="app">
            ...
            <nav class="navbar navbar-expand-lg navbar-light navbar-full" style="background-color: #C7CE9B">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                 Geo-bg.eu
                </a>
                
                <button class="navbar-toggler" type="button" data-toggle="collapse" class="navbar navbar-expand-lg navbar-light bg-light">
